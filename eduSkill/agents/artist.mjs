...
export async function runArtist(figureDesc, model = 'gc/gemini-2.5-flash', prev = null) {
...
export async function drawTikzFigure(figureDesc, outPath, model = 'gc/gemini-2.5-flash') {
  let prev = null
