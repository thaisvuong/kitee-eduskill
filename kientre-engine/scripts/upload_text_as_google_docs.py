...
if __name__=='__main__':
  ...
  kientre=ensure_folder('Kientre'); gia=ensure_folder('Gia sư',kientre['id']); sub=ensure_folder('SubHermes_GoogleDocs_Test',gia['id']); batch=ensure_folder(folder,sub['id'])
  uploaded=[]
  for md in pairs:
