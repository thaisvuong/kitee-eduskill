...
const ALIASES = {
 ...
 // Gói lệnh nhanh Kientre (/es = education skill): chạy đủ pipeline tương ứng.
 '/es': 'es-help', '/edu-skill': 'es-help', '/kientre': 'es-help',
...
const HELP = `
════════════════════════════════════════════════════
  SUB-HERMES / Kientre — Lệnh nhanh (slash commands)
════════════════════════════════════════════════════
 /topic <chủ đề> [lớp N] [môn] [--summary] [--special "…"] [--nb <id>]
