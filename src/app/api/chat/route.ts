...
export async function POST(req: Request) {
 ...
 try {
  if (/es-create|tạo chuyên đề/i.test(low)) {
   ...
   reply = `Đã dựng lệnh tạo đề:\n\n\`${cmd}\`\n\n${settings.uploadDrive ? 'Sẽ upload lên Drive Kientre sau khi xong.' : 'Lưu local, chưa upload Drive.'}`
